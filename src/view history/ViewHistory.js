      ...
      <Form layout="inline">
        ...
        >
          <Input
            ...
            onChange={(item) => {
              item.target.value === ""
                ? queryString.delete("patient_HN")
                : queryString.set("patient_HN", item.target.value);
            }}
            style={{ width: "200px" }}
          />
        </Form.Item>
        ...
        >
          <Select
            ...
            defaultValue={
              queryString.get("findings") === null
                ? "All"
                : queryString.get("findings")
            }
            onChange={(value) => {
              findings[value] === "all"
                ? queryString.delete("findings")
                : queryString.set("findings", findings[value]);
            }}
          >
            {findings.map((finding, i) => (
              <Option key={i} value={i}>
                {finding.charAt(0).toUpperCase() +
                  finding.slice(1).split("_").join(" ")}
              </Option>
            ))}
          </Select>
        </Form.Item>
        ...
        >
          <Input
            ...
            onChange={(item) => {
              item.target.value === ""
                ? queryString.delete("clinician")
                : queryString.set("clinician", item.target.value);
            }}
            style={{ width: "200px" }}
          />
        </Form.Item>
        ...
        >
          <DatePicker
            defaultValue={
              queryString.get("from") === null
                ? null
                : moment(new Date(queryString.get("from")))
            }
            onChange={(date) => {
              date === null
                ...
                : queryString.set(
                    "from",
                    date.startOf("day").toDate().toLocaleString()
                  );
            }}
            style={{ width: "200px" }}
          />
        ...
        >
          <DatePicker
            defaultValue={
              queryString.get("to") === null
                ? null
                : moment(new Date(queryString.get("to")))
            }
            onChange={(date) => {
              date === null
